...
const ROLE_PERMISSIONS = {
  ...
  project_manager: [
    P.CLIENT_READ_ALL, P.PROJECT_CREATE, P.PROJECT_READ_ALL, P.PROJECT_UPDATE,
    ...
    P.TICKET_READ, P.TICKET_REPLY, P.TICKET_ASSIGN,
  ],
  ...
  account_manager: [
    P.CLIENT_CREATE, P.CLIENT_READ_OWN, P.CLIENT_UPDATE,
    ...
    P.EXPENSE_READ,
    P.SALARY_READ,
    P.TICKET_READ, P.TICKET_UPDATE, P.TICKET_ASSIGN, P.TICKET_REPLY,
  ],
